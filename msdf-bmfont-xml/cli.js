...
const updateNotifier = async () => { await import('update-notifier') };
// const updateNotifier = (...args) => import('update-notifier').then(({ default: updateNotifier }) => updateNotifier(...args));
